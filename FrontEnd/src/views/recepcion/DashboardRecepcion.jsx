...
export const DashboardRecepcion = () => {
  ...
  useEffect(() => {
    if (localStorage.getItem('userRole') !== 'recepcion') navigate('/login');
  }, [navigate]);

  return (
    <div style={{ padding: '2rem', maxWidth: '1000px', margin: '0 auto' }}>
      <h1 style={{ color: '#1f2937', marginBottom: '1rem' }}>Recepción y Admisión</h1>
      <p style={{ color: '#4b5563' }}>Bienvenida al panel de control. Desde aquí puedes gestionar los expedientes de los pacientes y tomar sus signos vitales para la pre-clínica.</p>
