    ...
    <div className="landing-container">
      <div className="landing-card" style={{ maxWidth: "450px", width: "90%", padding: "3rem", gap: "1.5rem", boxSizing: "border-box" }}>
        ...
        <form className="login-form" onSubmit={handleSubmit(onSubmit)} style={{ width: "100%" }}>
          ...
          {errors.root && (<div style={{ color: "#ef4444", fontSize: "0.9rem", fontWeight: "bold", textAlign: "center" }}>{errors.root.message}</div>)}
        ...
        <Link to="/forgot-password" className="forgot-password" style={{ fontSize: "0.9rem", textAlign: "center" }}>Olvide mi Contrasena</Link>
      </div>
    </div>
  );
};
