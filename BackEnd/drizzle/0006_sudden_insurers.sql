...
ALTER TABLE `medical_consultations` ADD CONSTRAINT `medical_consultations_insurer_id_insurers_id_fk` FOREIGN KEY (`insurer_id`) REFERENCES `insurers`(`id`) ON DELETE set null ON UPDATE no action;
